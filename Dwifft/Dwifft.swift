...
public extension Array where Element: Equatable {
    ...
    public func diff(_ other: [Element], equatableFunction: (Element, Element) -> Bool ) -> Diff<Element> {
...
public extension Array where Element: Equatable {
    ...
    public func LCS(_ other: [Element], equatableFunction: (Element, Element) -> Bool ) -> [Element] {
        let table = MemoizedSequenceComparison.buildTable(self, other, self.count, other.count, equatableFunction)
...
internal struct MemoizedSequenceComparison<T: Equatable> {
    static func buildTable(_ x: [T], _ y: [T], _ n: Int, _ m: Int, _ isEqual: (T, T) -> Bool) -> [[Int]] {
